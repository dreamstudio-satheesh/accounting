...
class Utility extends Model
{
    public static function settings()
    {
        ...
        $settings = [
            ...
            "company_name" => "ஸ்ரீ விநாயகா ஹாலோபிளாக்ஸ்",
            "company_address" => "அல்லாளபுரம்ரோடு , கணபதிபாளையம்  ",
            "company_city" => " திருப்பூர்",
            "company_state" => "",
            "company_zipcode" => "641605",
            "company_country" => "",
            "company_telephone" => "",
            "company_email" => "",
            ...
            "decimal_number" => "2",
            "tax_type" => "",
            "shipping_display" => "off",
            "journal_prefix" => "#JUR",
            "display_landing_page" => "off",
            "title_text" => "ஸ்ரீ விநாயகா ஹாலோபிளாக்ஸ்",
            "invoice_template" => "template6",
            // 'gdpr_cookie' => "off",
            'cookie_text' => "",
            'enable_chatgpt' => "",
            "chatgpt_key" => "",
