    ...
    <div class="card-body table-border-style">
            ...
            <div class="table-responsive budget_plan d-block"  id="monthly">
                ...
                <div class="modal-footer">
                    ...
                    <input type="submit" value="{{__('Update')}}" class="btn  btn-primary" style="margin-left: 6px;margin-right: 25px;margin-bottom: 25px;margin-top: 25px;">
                </div>
            </div>
            <!---End Monthly Budget ----->
