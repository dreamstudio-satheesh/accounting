                                ...
                                @if (\Auth::user()->type == 'company')
                                    @if (\Auth::user()->can('contract description'))
                                        ...
                                        <div class="form-group mt-3">
                                            <textarea class="pc-tinymce-2" name="notes" id="notes" rows="8">{!! $contract->notes !!}</textarea>
                                        </div>
                                ...
                                <div id="notes">
                                    <div class="card">
                                        ...
                                        <div class="p-2 m-2">
                                            ...
                                            <a href="javascript:void(0)" data-size="md" data-ajax-popup-over="true"
                                                data-url="{{ route('grammar', ['grammar']) }}" data-bs-toggle="tooltip"
                                                data-bs-placement="top" title="{{ __('Generate Grammar') }}"
                                                ...
                                                @if (\Auth::user()->type == 'company')
                                                    @if (\Auth::user()->can('add notes'))
                                                        ...
                                                        <div class="form-group ">
                                                            <textarea rows="3" class="form-control tox-target pc-tinymce summernotes grammer_textarea" name="note"
