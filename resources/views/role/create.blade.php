            ...
            <div class="form-group">
                @if(!empty($permissions))
                    ...
                    <table class="table  mb-0" id="dataTable-1">
                        ...
                        <tbody>
                        @php
                            $modules=['dashboard','user','role','proposal','retainer','invoice','bill','revenue','payment','proposal product','invoice product','bill product','goal','credit note','debit note','bank account','transfer','transaction','product & service','customer','vender','plan','contract','constant tax','constant category','constant unit','constant custom field','company settings','assets','chart of account','journal entry','report'];
