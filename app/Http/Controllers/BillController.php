...
class BillController extends Controller
{
    ...
    //                     Utility::updateUserBalance('vendor', $bill->vender_id, $updatePrice, 'debit');
...
//                    $billProduct->discount    = isset($products[$i]['discount']) ? $products[$i]['discount'] : 0;
    ...
    //             foreach($bill->payments as $bills)
    //             {
    //                 Utility::bankAccountBalance($bills->account_id, $bills->amount, 'credit');

    //                 $billpayment = BillPayment::find($bills->id);
    //                 $bills->delete();
    //                 $billpayment->delete();
